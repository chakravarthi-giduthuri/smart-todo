    ...
    <div className="glass rounded-2xl p-4">
      <div className="flex items-center gap-3">
        ...
        <div className="flex-1">
          ...
          <p className="text-xs text-white/30 mt-0.5">15 min before task starts · Safari iOS 16.4+</p>
        </div>
        {permission === 'granted'
      ...
      {permission === 'denied' && (
        <p className="text-xs text-amber-400/70 mt-3 pl-13">Blocked — enable in Safari Settings › Notifications</p>
      )}
    </div>
  );
}
